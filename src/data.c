...
BMSParameterValues_t s_parameters =
{
    ...
    .commonBatteryVariables.V_cellVoltages.V_cellArr[6] = V_CELL7_DEFAULT,
    .commonBatteryVariables.V_cellVoltages.V_cellArr[7] = V_CELL8_DEFAULT,
    .commonBatteryVariables.V_cellVoltages.V_cellArr[8] = V_CELL9_DEFAULT,
    .commonBatteryVariables.V_cellVoltages.V_cellArr[9] = V_CELL10_DEFAULT,
    .commonBatteryVariables.V_cellVoltages.V_cellArr[10] = V_CELL11_DEFAULT,
    .commonBatteryVariables.V_cellVoltages.V_cellArr[11] = V_CELL12_DEFAULT,
    .commonBatteryVariables.V_cellVoltages.V_cellArr[12] = V_CELL13_DEFAULT,
    .commonBatteryVariables.V_cellVoltages.V_cellArr[13] = V_CELL14_DEFAULT,
    ...
    .additionalVariables.I_sleep_oc_discharge       = I_SLEEP_OC_DISCHARGE_DEFAULT,
    .additionalVariables.I_sleep_oc_charge          = I_SLEEP_OC_CHARGE_DEFAULT,
    .additionalVariables.I_sleep_oc_wakeup          = I_SLEEP_OC_WAKEUP_DEFAULT,
    ...
    .hardwareVariables.R_bal                        = R_BAL_DEFAULT,
...
const BMSparametersInfo_t s_parametersInfo[NONE] =
{
    ...
    { SET_DEFAULT_FLT(FLOATVAL,  true,  true, true,   "V",  "float",  V_CELL7, commonBatteryVariables.V_cellVoltages.V_cellArr[6]) },
    { SET_DEFAULT_FLT(FLOATVAL,  true,  true, true,   "V",  "float",  V_CELL8, commonBatteryVariables.V_cellVoltages.V_cellArr[7]) },
    { SET_DEFAULT_FLT(FLOATVAL,  true,  true, true,   "V",  "float",  V_CELL9, commonBatteryVariables.V_cellVoltages.V_cellArr[8]) },
    { SET_DEFAULT_FLT(FLOATVAL,  true,  true, true,   "V",  "float",  V_CELL10, commonBatteryVariables.V_cellVoltages.V_cellArr[9]) },
    { SET_DEFAULT_FLT(FLOATVAL,  true,  true, true,   "V",  "float",  V_CELL11, commonBatteryVariables.V_cellVoltages.V_cellArr[10]) },
    { SET_DEFAULT_FLT(FLOATVAL,  true,  true, true,   "V",  "float",  V_CELL12, commonBatteryVariables.V_cellVoltages.V_cellArr[11]) },
    { SET_DEFAULT_FLT(FLOATVAL,  true,  true, true,   "V",  "float",  V_CELL13, commonBatteryVariables.V_cellVoltages.V_cellArr[12]) },
    { SET_DEFAULT_FLT(FLOATVAL,  true,  true, true,   "V",  "float",  V_CELL14, commonBatteryVariables.V_cellVoltages.V_cellArr[13]) },
    ...
    { SET_DEFAULT_INT(UINT8VAL,  false, true, false,  "mA", "uint8",  I_SLEEP_OC_DISCHARGE, additionalVariables.I_sleep_oc_discharge) },
    { SET_DEFAULT_INT(UINT8VAL,  false, true, false,  "mA", "uint8",  I_SLEEP_OC_CHARGE, additionalVariables.I_sleep_oc_charge) },
    { SET_DEFAULT_INT(UINT8VAL,  false, true, false,  "mA", "uint8",  I_SLEEP_OC_WAKEUP, additionalVariables.I_sleep_oc_wakeup) },
    ...
    { SET_DEFAULT_INT(UINT8VAL,  true,  true, false,  "ohm","uint8",  R_BAL, hardwareVariables.R_bal) },
        ...
        switch(data_getType((parameterKind_t)i))
        {
            ...
            case STRINGVAL:
            {
                ...
                else
                {
                    ...
                    if(stringSize > (STRING_MAX_CHARS-1))
                    {
                        // limit
                        stringSize = (STRING_MAX_CHARS-1);
                    }
                    // check for 0
...
static int handleParamaterChange(parameterKind_t parameter, void* value)
{
    ...
    switch(parameter)
    {
        ...
        case T_MEAS:
            ...
            break;
        case V_MAX:
            // get the F_V_OUT_DIVIDER_FACTOR
            if(getParameterNoLock(F_V_OUT_DIVIDER_FACTOR, &(variable1.floatVar), NULL) == NULL)
            {
                cli_printfError("handleParamaterChange ERROR: getting F_V_OUT_DIVIDER_FACTOR went wrong!\n");
                return ret;
            }
            break;
        case F_V_OUT_DIVIDER_FACTOR:
            // get the F_V_OUT_DIVIDER_FACTOR
            if(getParameterNoLock(V_MAX, &(variable1.uint8Var), NULL) == NULL)
            {
                cli_printfError("handleParamaterChange ERROR: getting v-max went wrong!\n");
                return ret;
            }
            break;
        default:
