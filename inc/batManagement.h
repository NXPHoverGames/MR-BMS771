...
#define BMS_FAULT_CELL7_BIT_SHIFT             6
#define BMS_FAULT_CELL8_BIT_SHIFT             7
#define BMS_FAULT_CELL9_BIT_SHIFT             8
#define BMS_FAULT_CELL10_BIT_SHIFT            9
#define BMS_FAULT_CELL11_BIT_SHIFT            10
#define BMS_FAULT_CELL12_BIT_SHIFT            11
#define BMS_FAULT_CELL13_BIT_SHIFT            12
#define BMS_FAULT_CELL14_BIT_SHIFT            13
#define BMS_FAULT_R_TEMPERATURE_BIT_SHIFT     14
#define BMS_FAULT_BAT_TEMPERATURE_BIT_SHIFT   15
#define BMS_FAULT_T_TEMPERATURE_BIT_SHIFT     16
#define BMS_FAULT_AFE_TEMPERATURE_BIT_SHIFT   17
#define BMS_FAULT_CELL_UV_BIT_SHIFT           18
#define BMS_FAULT_CELL_OV_BIT_SHIFT           19
#define BMS_FAULT_SW_CELL_OV_BIT_SHIFT        20
#define BMS_FAULT_PCB_UV_BIT_SHIFT            21
#define BMS_FAULT_PCB_OV_BIT_SHIFT            22
#define BMS_FAULT_UT_BIT_SHIFT                23
#define BMS_FAULT_OT_BIT_SHIFT                24
#define BMS_FAULT_AVG_OVER_CURRENT_BIT_SHIFT  25
#define BMS_FAULT_PEAK_OVER_CURRENT_BIT_SHIFT 26
#define BMS_FAULT_SLEEP_OC_BIT_SHIFT          27
#define BMS_FAULT_CC_OVRERFLOW_BIT_SHIFT      28
#define BMS_FAULT_CSB_WAKEUP_BIT_SHIFT        29
#define BMS_FAULT_OTHER_FAULT_BIT_SHIFT       30
...
typedef enum
{
    ...
    BMS_CELL7               = (1<<BMS_FAULT_CELL7_BIT_SHIFT),               /*!< there is a fault with cell 7 */
    BMS_CELL8               = (1<<BMS_FAULT_CELL8_BIT_SHIFT),               /*!< there is a fault with cell 8 */
    BMS_CELL9               = (1<<BMS_FAULT_CELL9_BIT_SHIFT),               /*!< there is a fault with cell 9 */
    BMS_CELL10              = (1<<BMS_FAULT_CELL10_BIT_SHIFT),              /*!< there is a fault with cell 10 */
    BMS_CELL11              = (1<<BMS_FAULT_CELL11_BIT_SHIFT),              /*!< there is a fault with cell 11 */
    BMS_CELL12              = (1<<BMS_FAULT_CELL12_BIT_SHIFT),              /*!< there is a fault with cell 12 */
    BMS_CELL13              = (1<<BMS_FAULT_CELL13_BIT_SHIFT),              /*!< there is a fault with cell 13 */
    BMS_CELL14              = (1<<BMS_FAULT_CELL14_BIT_SHIFT),              /*!< there is a fault with cell 14 */
