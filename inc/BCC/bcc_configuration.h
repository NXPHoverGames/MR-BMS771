 ...
 * Global variable
 ******************************************************************************/
/* Check for the rddrone-bms772 design */
#if (BOARD_NAME == RDDRONE_BMS772_BOARD)
#   define BCC_DEVICE BCC_DEVICE_MC33772
#else
#   define BCC_DEVICE BCC_DEVICE_MC33771C
#endif

/* The amount of ADC sample to average C variant only! */
#define N_AVERAGE_ADC_SAMPLES       1

#define BCC_INITIAL_DRIVER_INSTANCE 0
#define BCC_DEVICES                 1
#define BCC_FIRST_INDEX             0
#define BCC_DEFAULT_CELLCNT         N_CELLS_MAX // 6 or 14
...
#   define ANX_C_T                     2   /*!< @brief ANx, the power switch transistor temperature input number */
#   define ANX_C_AFE                   3   /*!< @brief ANx, the analog front end temperature input number */
#   define ANX_V_OUT                   4   /*!< @brief ANx, the Vout/11 voltage input number */
#else
#   define ANX_C_R                     1   /*!< @brief ANx, the Rsense temperature input number */
#   define ANX_C_BATT                  3   /*!< @brief ANx, the battery temperature input number */
#   define ANX_C_AFE                   1   /*!< @brief ANx, the analog front end temperature input number */
#   define ANX_C_T                     1   /*!< @brief ANx, the power switch transistor temperature input number */
#endif
...
/* If the old device, define BCC_CSB_WUP_WAKEUP_VAL */
#if (BOARD_NAME == RDDRONE_BMS772_BOARD)
/*! @brief Voltage divider coeficient for Vbatt-out measured value. */
#   define VOLTDIV_BATT_OUT             11
/*! @brief The first cells that are always connected to that BCC input, the rest is connected from the top. */
#   define FIRST_BCC_CELLS              2
#else
/*! @brief Voltage divider coeficient for Vbatt-out measured value. */
#   define VOLTDIV_BATT_OUT             18.86 // if need to remove float,:(*7 = 132)
/*! @brief The first cells that are always connected to that BCC input, the rest is connected from the top. */
#   define FIRST_BCC_CELLS              4
#endif
/*******************************************************************************
...
/* If the old device, define BCC_CSB_WUP_WAKEUP_VAL */
#if (BOARD_NAME == RDDRONE_BMS772_BOARD)
#   define BCC_CB_AUTO_PAUSE_VAL BCC_CB_AUTO_PAUSE_DISABLED
#else
#   define BCC_CB_AUTO_PAUSE_VAL 0
#endif
...
#define BCC_CONF1_SYS_CFG1_VALUE ( \
    ...
    BCC_DIAG_TIMEOUT_1S | \
    BCC_I_MEAS_ENABLED | \
    BCC_CB_AUTO_PAUSE_VAL /*BCC_CB_AUTO_PAUSE_ENABLED*/ | \
    BCC_CB_DRV_DISABLED | \
...
/* If the old device, define BCC_CSB_WUP_WAKEUP_VAL */
#if (BOARD_NAME == RDDRONE_BMS772_BOARD)
#   define BCC_CHAR_COMP_VAL BCC_CHAR_COMP_ENABLED
#else
#   define BCC_CHAR_COMP_VAL 0
#endif

/* Initial value of ADC_CFG register. */
#define BCC_CONF1_ADC_CFG_VALUE ( \
    /* Note: BMS772: TAG_ID is zero. BMS771: AVG is off */ \
...
/* If the RDDRONE_BMS772_BOARD device, define BCC_CSB_WUP_WAKEUP_VAL */
#if (BOARD_NAME == RDDRONE_BMS772_BOARD)
#   define BCC_CSB_WUP_WAKEUP_VAL BCC_CSB_WUP_WAKEUP_EN
#else
#   define BCC_CSB_WUP_WAKEUP_VAL 0
#endif
...
#define BCC_CONF1_TH_ISENSE_OC_VALUE ( \
    /* ISENSE OC threshold is 24576 mA (2458 uV using 500 uOhm resistor). It is enabled/disabled through FAULT_MASK1 and WAKEUP_MASK1 register. */ \
    BCC_SET_TH_ISENSE_OC((I_SLEEP_OC_WAKEUP_DEFAULT*SHUNT_RESISTOR))/*2458U)*/ \
)
 ...
 ******************************************************************************/
/* If the new device, define BCC_INIT_CONF_REG_CNT */
#ifndef BCC_INIT_CONF_REG_CNT
#   define BCC_INIT_CONF_REG_CNT MC33771C_INIT_CONF_REG_CNT
#endif // BCC_INIT_CONF_REG_CNT

#ifndef BCC_REG_MEAS_CELLX_ADDR_MC3377X_START
#   define BCC_REG_MEAS_CELLX_ADDR_MC3377X_START BCC_REG_MEAS_CELLX_ADDR_MC33772_START
#endif

#ifndef BCC_MSR_CELL_VOLTX
#   define BCC_MSR_CELL_VOLTX BCC_MSR_CELL_VOLT6
#endif
...
#else // #if (BOARD_NAME == RDDRONE_BMS772_BOARD)
...
static const uint16_t BCC_INIT_CONF[1][BCC_INIT_CONF_REG_CNT] = {
    {
        ...
        BCC_CONF1_GPIO_CFG2_VALUE,          /*!< on GPIO0 disable trigger, no wake-up, does not activate fault pin. and GPIOx could be set high or low */
        BCC_CONF1_TH_ALL_CT_VALUE,          /*!< 2509 - 4195 mv overvoltage and undervoltage threshold for all cell terminals */
        BCC_CONF1_TH_CT14_VALUE,            /*!< 2509 - 4195 mv overvoltage and undervoltage threshold for this cell terminal */
        BCC_CONF1_TH_CT13_VALUE,            /*!< 2509 - 4195 mv overvoltage and undervoltage threshold for this cell terminal */
        BCC_CONF1_TH_CT12_VALUE,            /*!< 2509 - 4195 mv overvoltage and undervoltage threshold for this cell terminal */
        BCC_CONF1_TH_CT11_VALUE,            /*!< 2509 - 4195 mv overvoltage and undervoltage threshold for this cell terminal */
        BCC_CONF1_TH_CT10_VALUE,            /*!< 2509 - 4195 mv overvoltage and undervoltage threshold for this cell terminal */
        BCC_CONF1_TH_CT9_VALUE,             /*!< 2509 - 4195 mv overvoltage and undervoltage threshold for this cell terminal */
        BCC_CONF1_TH_CT8_VALUE,             /*!< 2509 - 4195 mv overvoltage and undervoltage threshold for this cell terminal */
        BCC_CONF1_TH_CT7_VALUE,             /*!< 2509 - 4195 mv overvoltage and undervoltage threshold for this cell terminal */
        BCC_CONF1_TH_CT6_VALUE,             /*!< 2509 - 4195 mv overvoltage and undervoltage threshold for this cell terminal */
        BCC_CONF1_TH_CT5_VALUE,             /*!< 2509 - 4195 mv overvoltage and undervoltage threshold for this cell terminal */
        BCC_CONF1_TH_CT4_VALUE,             /*!< 2509 - 4195 mv overvoltage and undervoltage threshold for this cell terminal */
        BCC_CONF1_TH_CT3_VALUE,             /*!< 2509 - 4195 mv overvoltage and undervoltage threshold for this cell terminal */
        ...
        BCC_CONF1_CB5_CFG_VALUE,            /*!< CB on and 0xFF The cell balance configuration register holds the operating parameters of the cell balance output drivers.*/
        BCC_CONF1_CB6_CFG_VALUE,            /*!< CB on and 0xFF The cell balance configuration register holds the operating parameters of the cell balance output drivers.*/
        BCC_CONF1_CB7_CFG_VALUE,            /*!< CB on and 0xFF The cell balance configuration register holds the operating parameters of the cell balance output drivers.*/
        BCC_CONF1_CB8_CFG_VALUE,            /*!< CB on and 0xFF The cell balance configuration register holds the operating parameters of the cell balance output drivers.*/
        BCC_CONF1_CB9_CFG_VALUE,            /*!< CB on and 0xFF The cell balance configuration register holds the operating parameters of the cell balance output drivers.*/
        BCC_CONF1_CB10_CFG_VALUE,           /*!< CB on and 0xFF The cell balance configuration register holds the operating parameters of the cell balance output drivers.*/
        BCC_CONF1_CB11_CFG_VALUE,           /*!< CB on and 0xFF The cell balance configuration register holds the operating parameters of the cell balance output drivers.*/
        BCC_CONF1_CB12_CFG_VALUE,           /*!< CB on and 0xFF The cell balance configuration register holds the operating parameters of the cell balance output drivers.*/
        BCC_CONF1_CB13_CFG_VALUE,           /*!< CB on and 0xFF The cell balance configuration register holds the operating parameters of the cell balance output drivers.*/
        BCC_CONF1_CB14_CFG_VALUE,           /*!< CB on and 0xFF The cell balance configuration register holds the operating parameters of the cell balance output drivers.*/
        BCC_CONF1_OV_UV_EN_VALUE,           /*!< OV and UV to common and all TH on.*/
        BCC_CONF1_SYS_CFG1_VALUE,           /*!< cyclic cont. and diag 1s, I_meas enabled CB disabled and auto pause, diag, CB man pause, soft rst and fault wave (500us) disabled The SYS_CFG1 register contains control bits and register settings that allow the user to adapt the 33772 to specific applications and system requirements. */
        BCC_CONF1_SYS_CFG2_VALUE,           /*!< OSC fault monitoring and reset enabled, BCC timeout com 128 ms, even number of cells!, DED HAMM Decode*/
        BCC_CONF1_ADC_CFG_VALUE,            /*!< tag id 0, SOC disable (dont activate on demand conversion now), automatic PGA, no CC rst (dont rst coulomb counter now), set all ADC res to 16 bit */
...
#endif // #if (BOARD_NAME == RDDRONE_BMS772_BOARD)
/*******************************************************************************
 * Function prototypes
 ******************************************************************************/
